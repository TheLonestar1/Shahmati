...
/*int logic_mat(int tab[9][9],int a, int b, int c,int d,char shma,int *mat){
        if(shma != '+') return 0;
                ...
                case 5:
                        if((tab[c+1][d+2] == 10) || (tab[c+1][d-2] == 10) ||
(tab[c-1][b+2] == 10) || (tab[c-1][b-2] == 10) || (tab[c+2][d+1] == 10) ||
(tab[c+2][d-1] == 10) || (tab[c-2][d+1]) || (tab[c-2][d-1] == 10)) {
...
/*int logic_shah(int tab[9][9],int a, int b, int c,int d,char shma){
        ...
        switch(tab[a][b]){
                case 0:
                        if((tab[c+1][d-1] == 10) || (tab[c+1][d+1]) == 10)
return 1; else return 0; case 1: for(int i = 1; i < 9; i++){ if(tab[c][i] == 10)
return 1; if(tab[i][d] == 10) return 1;
                        }
                        return 0;
                case 2:
                        for(int i = 0; i < 9 - c; i++){
                ...
                case 5:
                        if((tab[c+1][d+2] == 10) || (tab[c+1][d-2] == 10) ||
(tab[c-1][b+2] == 10) || (tab[c-1][b-2] == 10) || (tab[c+2][d+1] == 10) ||
(tab[c+2][d-1] == 10) || (tab[c-2][d+1]) || (tab[c-2][d-1] == 10)) { return 1;
                        }
                        else return 0;
                case 3:
                        return 0;
...
(tab[a-1][b] != 8) || (tab[a-1][b-1] != 8) && (tab[a][b] == 10)){ mat = 1;
        }
}*/
